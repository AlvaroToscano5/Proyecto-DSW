...
CREATE PROCEDURE usp_RecargarSaldo(@COD CHAR(10), @MON DECIMAL(10,2), @FRG VARCHAR(50), @DNI VARCHAR(50), @USU CHAR(10))
AS
BEGIN
...
CREATE PROCEDURE usp_GenerarReclamo (@CODIGO CHAR(10), @DNIUSUARIO VARCHAR(50),@NOMBREUSUARIO VARCHAR(10), @APELLIDOUSUARIO VARCHAR(50),@TIPOUSUARIO VARCHAR(50),
@FECHAREG VARCHAR(5) ,@ESTADO VARCHAR(50),@DESCRIPCION VARCHAR(50),@USUARIOCODIGO CHAR(10), @ESTACIONCODGIO CHAR(10),@EMPLEADOCODIGO CHAR(10) 
)
AS
BEGIN
INSERT INTO RECLAMO VALUES (@CODIGO, @DNIUSUARIO,@NOMBREUSUARIO, @APELLIDOUSUARIO,@TIPOUSUARIO,
@FECHAREG,@ESTADO,@DESCRIPCION,@USUARIOCODIGO, @ESTACIONCODGIO,@EMPLEADOCODIGO)
END
GO

exec usp_GenerarReclamo '','','','','','','','','','',''
/*LISTAR LOS RECLAMOS*/

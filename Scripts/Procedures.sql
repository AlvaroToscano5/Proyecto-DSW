...
CREATE PROCEDURE usp_ListarUsuarioxDni(@DNI VARCHAR(10))
AS
BEGIN
SELECT CODIGO, DNI FROM USUARIO WHERE DNI = @DNI
END
GO
...
CREATE PROCEDURE usp_ActualizarSaldo(@SAL CHAR(5), @DNI VARCHAR(10))
AS
BEGIN
UPDATE USUARIO SET SALDO = @SAL WHERE DNI = @DNI
END
GO
...
CREATE PROCEDURE usp_ListarRecargaxUsuario(@USU CHAR(10))
AS
BEGIN
SELECT * FROM RECARGA WHERE USUARIOCODIGO = @USU
END
GO

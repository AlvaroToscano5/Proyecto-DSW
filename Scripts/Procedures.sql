...
CREATE PROCEDURE usp_GenerarReclamo (@COD CHAR(10), @DNI VARCHAR(50), @NOM VARCHAR(10), @APE VARCHAR(50), @TIP VARCHAR(50),
@FRG DATETIME, @FAC DATETIME, @ETR VARCHAR(50), @DES VARCHAR(50), @USU CHAR(10), @EST CHAR(10),@EMP CHAR(10) 
)
AS
BEGIN
